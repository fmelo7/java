...
public class DeviceswifiResponsePATCH {
	...
	@SerializedName("data")
	private DeviceswifiResponsePATCHData data = null;

	public DeviceswifiResponsePATCH apiVersion(String apiVersion) {
	...
	public DeviceswifiResponsePATCH transactionId(String transactionId) {
	...
	public DeviceswifiResponsePATCH data(DeviceswifiResponsePATCHData data) {
		this.data = data;
		return this;
	}
	...
	public DeviceswifiResponsePATCHData getData() {
		return data;
	}

	public void setData(DeviceswifiResponsePATCHData data) {
		this.data = data;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		DeviceswifiResponsePATCH deviceswifiResponsePATCH = (DeviceswifiResponsePATCH) o;
		return Objects.equals(this.apiVersion, deviceswifiResponsePATCH.apiVersion)
				&& Objects.equals(this.transactionId, deviceswifiResponsePATCH.transactionId)
				&& Objects.equals(this.data, deviceswifiResponsePATCH.data);
	}
	...
	public String toString() {
		...
		sb.append("class DeviceswifiResponsePATCH {\n");
