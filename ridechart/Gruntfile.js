...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		connect : {
			...
			proxies : [ {
				context : '/data-service', // the context of the data service
	...
	grunt.registerTask('serve', 'Compile then start a connect web server', function(target) {
		...
		grunt.task.run([ 'clean:server', 'configureProxies:server', // add this line
		'wiredep', 'concurrent:server', 'postcss:server', 'connect:livereload', 'watch' ]);
	});
	...
	grunt.registerTask('build', [ 'clean:dist', 'wiredep', 'useminPrepare', 'concurrent:dist', 'postcss', 'ngtemplates',
